...
- **[Network Hardening and WLAN Security](https://github.com/TamarasLabsinSec/netlock-wlan)**  
...
- **[Firewall & IDS/IPS Deployment](https://github.com/TamarasLabsinSec/netlock-wlan#firewall--idsips-deployment)**  
...
- **[OSI Troubleshooting Trainer](https://github.com/TamarasLabsinSec/osi-trainer)**  
...
- **[Metasploitable2 Exploitation](https://github.com/TamarasLabsinSec/web-net-exploit#network-service-exploitation)**  
Exploited VSFTPD 2.3.4 (CVE-2011-2523) to gain root access using Metasploit.

- **[Web Application Testing](https://github.com/TamarasLabsinSec/web-net-exploit)**  
...
- **[TryHackMe Red](https://github.com/TamarasLabsinSec/thm-red.blue/blob/main/README.md#offensive-security)**  
...
- **[Secure Bank](https://github.com/TamarasLabsinSec/secure_bank)**  
  Full-stack secure banking simulation with authentication, backend API integration, and secure frontend communication.

- **[Real-Time Global Whiteboard](https://github.com/TTamarasLabsinSec/whiteboard)**  
...
- **[Multi-Tier Application Lab (LocalStack)](https://github.com/TamarasLabsinSec/terraform-localstack-multi-tier-app)**  
...
- **[Serverless CRUD API (LocalStack)](https://github.com/TamarasLabsinSec/localstack-crud-api)**  
...
- **[Document Processing Lab (Terraform)](https://github.com/TamarasLabsinSec/terraform-doc-processing-lab)**  
...
- **[Password Manager App](https://github.com/TamarasLabsinSec/password-manager)**  
  Local password manager with encryption, master key access, and password generator. Built with Python and Tkinter. (Python)

- **[Ransomware Simulator](https://github.com/TamarasLabsinSec/ransomware-sim)**  
  AES-256 encryption/decryption of folder files for educational use. (C#)

- **[Keylogger](https://github.com/TamarasLabsinSec/keylogger)**  
